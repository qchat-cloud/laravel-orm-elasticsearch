...
namespace Qchat\Elasticsearch;

use Qchat\Elasticsearch\Commands\ReindexCommand;
use Elasticsearch\ClientBuilder as ElasticBuilder;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Support\ServiceProvider;
use Laravel\Scout\EngineManager;
use Illuminate\Support\Str;
use Qchat\Elasticsearch\Commands\ListIndicesCommand;
use Qchat\Elasticsearch\Commands\CreateIndexCommand;
use Qchat\Elasticsearch\Commands\DropIndexCommand;
use Qchat\Elasticsearch\Commands\UpdateIndexCommand;

/**
 * Class ElasticsearchServiceProvider
 * @package Qchat\Elasticsearch
 */
